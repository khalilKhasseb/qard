...
const subscriptionStatus = computed(() => {
    if (!props.subscription) return { text: t('dashboard.subscription.free_plan'), color: 'gray' };
    if (props.subscription.is_trial) return { text: t('dashboard.subscription.trial'), color: 'blue' };
    if (props.subscription.status === 'active') return { text: t('dashboard.subscription.active'), color: 'green' };
    return { text: t('dashboard.subscription.inactive'), color: 'red' };
});
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-sm font-medium text-gray-500">{{ t('dashboard.stats.total_cards') }}</p>
                    ...
                    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-sm font-medium text-gray-500">{{ t('dashboard.stats.published') }}</p>
                    ...
                    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-sm font-medium text-gray-500">{{ t('dashboard.stats.total_views') }}</p>
                    ...
                    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-sm font-medium text-gray-500">{{ t('dashboard.stats.themes') }}</p>
                    ...
                    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-sm font-medium text-gray-500">{{ t('dashboard.stats.nfc_taps') }}</p>
                ...
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-gray-900">{{ t('dashboard.subscription.status') }}</h3>
                                ...
                                <p v-if="subscription && subscription.days_remaining" class="mt-1 text-sm text-gray-500">
                                    {{ t('dashboard.subscription.days_remaining', { count: subscription.days_remaining }) }}
                                </p>
                            </div>
                    ...
                    <Link href="/cards/create" class="block overflow-hidden bg-white shadow-sm sm:rounded-lg hover:shadow-md transition-shadow">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-lg font-semibold text-gray-900">{{ t('dashboard.actions.create_card') }}</p>
                                    <p class="text-sm text-gray-500">{{ t('dashboard.actions.create_card_desc') }}</p>
                                </div>
                            </div>
                        </div>
                    </Link>
                    ...
                    <Link href="/themes" class="block overflow-hidden bg-white shadow-sm sm:rounded-lg hover:shadow-md transition-shadow">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-lg font-semibold text-gray-900">{{ t('dashboard.actions.manage_themes') }}</p>
                                    <p class="text-sm text-gray-500">{{ t('dashboard.actions.manage_themes_desc') }}</p>
                                </div>
                            </div>
                        </div>
                    </Link>
                    ...
                    <Link href="/cards" class="block overflow-hidden bg-white shadow-sm sm:rounded-lg hover:shadow-md transition-shadow">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ms-4">
                                    <p class="text-lg font-semibold text-gray-900">{{ t('dashboard.actions.view_cards') }}</p>
                                    <p class="text-sm text-gray-500">{{ t('dashboard.actions.view_cards_desc') }}</p>
                                </div>
                            </div>
                        </div>
                    </Link>
                ...
                <div v-if="recentCards.length > 0" class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ t('dashboard.recent_cards') }}</h3>
                        <div class="space-y-3">
                            <Link v-for="card in recentCards" 
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="text-end">
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">{{ t('dashboard.views_count', { count: card.views_count }) }}</p>
                                    </div>
                                </div>
                            </Link>
                        </div>
